...
| | |
|---|---|
| Status | Implemented; a funded end-to-end send verified on the iOS sim on `0.3.4` through the [keychain](#keychain) registry and a signing session, and the shippable build verified green on CI ([section 7](#7-testing)). First human review (2026-09-11) addressed; awaiting re-review |
| Author | Jon Tzeng |
| Reviewer | peachbits |
...
<!-- tdd-code-fingerprint: 064520f4016b42d4e5a95fcbc1f2120bc459efb1 -->
...
[`src/piratechain/piratechainIo.ts`](https://github.com/EdgeApp/edge-currency-accountbased/blob/e794905daf1036107b2dc5f284bbd8935f96f4ce/src/piratechain/piratechainIo.ts)
```ts
...
[`src/piratechain/PiratechainEngine.ts`](https://github.com/EdgeApp/edge-currency-accountbased/blob/e794905daf1036107b2dc5f284bbd8935f96f4ce/src/piratechain/PiratechainEngine.ts)
```ts
