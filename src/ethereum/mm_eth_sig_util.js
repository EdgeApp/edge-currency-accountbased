...
//     }
//     return sanitizedData as TypedMessage<T>;
//   },
...
// function recoverPersonalSignature<T>(
...
// function signTypedDataLegacy<T>(
//   privateKey: Buffer,
//   msgParams: MsgParams<TypedData | TypedMessage<T>>
// ): string {
...
// function recoverTypedSignatureLegacy<T>(
//   msgParams: SignedMsgParams<TypedData | TypedMessage<T>>
// ): string {
//   const msgHash = typedSignatureHash(msgParams.data);
...
// function recoverTypedMessage<T>(
//   msgParams: SignedMsgParams<TypedData | TypedMessage<T>>,
//   version: Version = 'V4'
// ): string {
//   switch (version) {
...
// function recoverTypedSignature<T>(
//   msgParams: SignedMsgParams<TypedData | TypedMessage<T>>
// ): string {
//   const message = TypedDataUtils.sign(msgParams.data, false);
...
// function recoverTypedSignature_v4<try {
