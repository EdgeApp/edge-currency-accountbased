...
export const protobufPackage = "cosmos";
...
/** UintProto defines a Protobuf wrapper around an Uint object. */
...
function createBaseUint(): Uint {
  return { int: "" };
}

export const Uint = {
  encode(message: Uint, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.int !== "") {
      writer.uint32(10).string(message.int);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Uint {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseUint();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): Uint {
    return { int: isSet(object.int) ? globalThis.String(object.int) : "" };
  },

  toJSON(message: Uint): unknown {
    const obj: any = {};
    if (message.int !== "") {
      obj.int = message.int;
    }
  ...
  create<I extends Exact<DeepPartial<Uint>, I>>(base?: I): Uint {
    return Uint.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Uint>, I>>(object: I): Uint {
    const message = createBaseUint();
    message.int = object.int ?? "";
    return message;
  },
...
function createBaseAccAddress(): AccAddress {
  return { address: new Uint8Array(0) };
}

export const AccAddress = {
  encode(message: AccAddress, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): AccAddress {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAccAddress();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  create<I extends Exact<DeepPartial<AccAddress>, I>>(base?: I): AccAddress {
    return AccAddress.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AccAddress>, I>>(object: I): AccAddress {
    const message = createBaseAccAddress();
