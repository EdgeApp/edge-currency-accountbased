...
function createBaseData(): Data {
  return { txs: [], hash: new Uint8Array(0) };
}
...
export const Commit = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          message.bitArray = BitArray.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  toJSON(message: Commit): unknown {
    ...
    if (message.bitArray !== undefined) {
      obj.bitArray = BitArray.toJSON(message.bitArray);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Commit>, I>>(object: I): Commit {
    ...
    message.bitArray = (object.bitArray !== undefined && object.bitArray !== null)
      ? BitArray.fromPartial(object.bitArray)
      : undefined;
    return message;
  },
};
