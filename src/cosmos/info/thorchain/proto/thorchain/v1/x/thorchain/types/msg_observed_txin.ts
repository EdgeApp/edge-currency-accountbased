...
export const MsgObservedTxIn = {
  ...
  create<I extends Exact<DeepPartial<MsgObservedTxIn>, I>>(base?: I): MsgObservedTxIn {
    return MsgObservedTxIn.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgObservedTxIn>, I>>(object: I): MsgObservedTxIn {
    const message = createBaseMsgObservedTxIn();
