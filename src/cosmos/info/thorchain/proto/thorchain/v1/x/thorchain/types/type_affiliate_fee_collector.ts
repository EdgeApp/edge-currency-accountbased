...
export const AffiliateFeeCollector = {
  encode(message: AffiliateFeeCollector, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): AffiliateFeeCollector {
  ...
  create<I extends Exact<DeepPartial<AffiliateFeeCollector>, I>>(base?: I): AffiliateFeeCollector {
    return AffiliateFeeCollector.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AffiliateFeeCollector>, I>>(object: I): AffiliateFeeCollector {
    const message = createBaseAffiliateFeeCollector();
